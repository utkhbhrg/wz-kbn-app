                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your EH-ISMAC cluster rules."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your EH-ISMAC cluster decoders."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your EH-ISMAC cluster CDB lists."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your EH-ISMAC cluster configuration."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem />
                </EuiFlexGroup>
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your EH-ISMAC cluster status."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Visualize your EH-ISMAC cluster."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Logs from your EH-ISMAC cluster."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
