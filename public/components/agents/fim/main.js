...
exports.MainFim = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(class MainFim extends react_1.Component {
    ...
    render() {
        ...
        if (selectView) {
            return (react_1.default.createElement("div", null,
                selectView === 'inventory' && (existsCurrentAgent &&
                    react_1.default.createElement(index_1.Inventory, Object.assign({}, this.props, { agent: this.props.currentAgentData }))),
                selectView === 'inventory' && (this.props.agent &&
                    react_1.default.createElement(index_1.Inventory, Object.assign({}, this.props, { agent: this.props.agent }))),
                selectView === 'inventory' && (!existsCurrentAgent && !this.props.agent &&
                    (react_1.default.createElement(eui_1.EuiEmptyPrompt, { iconType: "watchesApp", title: react_1.default.createElement("h2", null, "No agent is selected"), body: react_1.default.createElement(react_1.Fragment, null,
                            react_1.default.createElement("p", null, "You need to select an agent to see Integrity Monitoring inventory.")), actions: react_1.default.createElement(eui_1.EuiButton, { color: "primary", fill: true, onClick: () => this.showExploreAgentModal() }, "Select agent") })))));
        }
        else {
            return false;
        }
