...
class RegistryTable extends react_1.Component {
    ...
    async showFlyout(file, item, redirect = false) {
        ...
        if (!redirect) {
            ...
            const response = await wz_request_1.WzRequest.apiReq('GET', `/syscheck/${this.props.agent.id}`, { 'file': file });
    ...
    async getSyscheck() {
        ...
        try {
            const syscheck = await wz_request_1.WzRequest.apiReq('GET', `/syscheck/${agentID}`, this.buildFilter());
            this.setState({
    ...
    render() {
        ...
        return (react_1.default.createElement("div", null,
            registryTable,
            this.state.isFlyoutVisible && (react_1.default.createElement(eui_1.EuiOverlayMask, { onClick: (e) => e.target.className === 'euiOverlayMask' && this.closeFlyout() },
